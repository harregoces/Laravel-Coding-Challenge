...
> The Laravel scaffold itself is not committed. Run the bootstrap script to create Laravel 12 in-place and apply this overlay.
...
- <img width="20" height="20" alt="image" src="https://github.com/user-attachments/assets/1cbde537-d430-4209-9f22-1b8cd5ce0544" />  **AI Use Transparency** - If you used any AI tool, document it in [AI_USAGE.md](AI_USAGE.md) (what, where, and your review of it)
