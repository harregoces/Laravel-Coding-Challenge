...
<html>
  ...
  <body>
    ...
    <div class="banner">Client mode: <strong>{{ strtoupper(config('quotes.client')) }}</strong></div>
    <hr>
    <div class="content">
      @yield('content')
    </div>
    <hr>
    <footer>
      <small>Quotes by <a href="https://zenquotes.io/" target="_blank" rel="noopener">zenquotes.io</a></small>
    </footer>
